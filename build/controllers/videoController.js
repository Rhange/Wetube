    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            searchingBy = req.query.term; //! Beautiful
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            id = req.params.id; // console.log(req.user);
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 9:
            ...
            user.videos = user.videos.filter(function (each) {
              return String(each) !== video.id;
            });
            user.save(); // const commentCreatorArray = video.comments.map(each => each.creator);
...
var postDeleteComment = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(req, res) {
    var id, commentId, user, video, videoCommentsIdArray, userCommentsIdArray;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            id = req.params.id, commentId = req.body.commentId, user = req.user;
            _context10.prev = 1;
            _context10.next = 4;
            return _Video["default"].findById(id).populate("comments");
          ...
          case 4:
            ...
            videoCommentsIdArray = video.comments.map(function (each) {
              return each.id;
            ...
            video.comments = videoCommentsIdArray.filter(function (each) {
              return String(each) !== commentId;
            });
            video.save(); //! Update User model's comments
            // console.log(user.comments);

            userCommentsIdArray = user.comments; // console.log(userCommentsIdArray);
            // console.log(typeof userCommentsIdArray[0]);
            // console.log(userCommentsIdArray.filter(each => String(each) !== commentId));

            user.comments = userCommentsIdArray.filter(function (each) {
              return String(each) !== commentId;
            });
            user.save();
            res.status(200);
