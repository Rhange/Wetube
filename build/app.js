...
var CookieStore = (0, _connectMongo["default"])(_expressSession["default"]); // TODO middleware helmet, morgan, cookie-parser, body-parser(json, urlencoded)

app.use((0, _helmet["default"])()); // ? PUG
...
app.use(_middlewares.localsMiddleware); //! locals 위에 있는 것은 locals에 접근 X
